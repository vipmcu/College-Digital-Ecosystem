...
const servicesData: ServiceCardData[] = [
  ...
  },
  {
    id: "lms-portal",
    code: "POST-MVP / LMS",
    title: "ระบบห้องเรียนออนไลน์ & คลังบทเรียน (LMS)",
    titleEn: "Learning Management System & Virtual Classrooms",
    desc: "ห้องเรียนเสมือนจริง สื่อวิดีโอย้อนหลัง กล่องส่งการบ้านพร้อมตรวจจับเวลา และศูนย์แบบทดสอบออนไลน์เก็บคะแนนแบบ Real-time",
    icon: "school",
    badge: "Post-MVP พร้อมใช้งาน",
    badgeType: "primary",
    category: "student",
    href: "/lms",
    cta: "เข้าสู่ห้องเรียนดิจิทัล",
    ctaIcon: "play_lesson",
    tags: ["lms", "ห้องเรียน", "การบ้าน", "วิดีโอ", "บทเรียน", "quiz", "student"],
  },
  {
    id: "research-portal",
    code: "POST-MVP / RES",
    title: "ระบบบริหารงานวิจัยและผลงานวิชาการ",
    titleEn: "Research Grants & Publications Portal",
    desc: "ยื่นข้อเสนอขอทุนอุดหนุนการวิจัยภายใน/ภายนอก ติดตามรายงานความก้าวหน้า ตรวจสอบจริยธรรม IRB และคลังผลงานตีพิมพ์ Scopus/TCI",
    icon: "science",
    badge: "Post-MVP พร้อมใช้งาน",
    badgeType: "primary",
    category: "faculty",
    href: "/research",
    cta: "เข้าสู่ศูนย์บริหารงานวิจัย",
    ctaIcon: "biotech",
    tags: ["วิจัย", "research", "ทุนวิจัย", "ตีพิมพ์", "scopus", "tci", "faculty"],
  },
